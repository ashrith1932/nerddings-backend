...
import { projectInterestsRouter } from "./routes/project-interests.js";
...
app.use("/api/v1/social",socialFeedViewRouter);app.use("/api/v1/social",socialProfileViewRouter);app.use("/api/v1/social",socialProfileLiveRouter);app.use("/api/v1/social",socialPostDetailRouter);app.use("/api/v1/social",socialProjectsRouter);app.use("/api/v1/social",projectInterestsRouter);app.use("/api/v1/social",socialMessageMetaRouter);app.use("/api/v1/social",socialPostCreateRouter);app.use("/api/v1/social",socialAmplifyRouter);
