...
socialFeedViewRouter.get("/feed", async (req, res) => {
  ...
  /*
   * This query intentionally follows src/db/schema.ts and the production SQL.
   * Do not reference fields such as github_url, quote_post_id or link_url here:
   * those columns do not exist in the canonical posts/projects schema.
   */
